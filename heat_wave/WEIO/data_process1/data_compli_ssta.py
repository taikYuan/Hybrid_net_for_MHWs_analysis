...
anom0 = nc0.variables['anom'][:,327:393,216:265]
...
for i in list_nc0:
    ...
    print(time1)
#
    anom1 = nc1.variables['anom'][:,327:393,216:265]
    ...
    np.savez(r'D:\heat_wave\WEIO\expand_WEIO\SSTa_82_21_expand_WEIO_area.npz', time=time0, lat=lat, lon=lon, anom = anom0,
             )

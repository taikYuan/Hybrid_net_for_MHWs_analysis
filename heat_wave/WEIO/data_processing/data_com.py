...
for cc in range(3,10):
    ...
    data = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_01_deep30_all_area.npz'.format(cc,cc))
    ...
    mld1 = data['mld'][:,312:329,912:937]
    print(mld1.shape) #(31, 41, 201)

    salinity1 = data['salinity'][:]
    print('salinity1.shape:{}'.format(salinity1.shape)) #(31, 30, 681, 1440) #30是深度

    salinity1 = salinity1[:,:,312:329,912:937]
    print(salinity1.shape) #(31, 30, 41, 201) #30是深度

    temp1 = data['temp'][:,:,312:329,912:937]
    print(temp1.shape)
    #
    u1 = data['u'][:,:,312:329,912:937]
    #
    v1 = data['v'][:,:,312:329,912:937]
    #
    #
    data2 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_02_deep30_all_area.npz'.format(cc,cc))
    time2 = data2['time'][:]
    mld2 = data2['mld'][:,312:329,912:937]
    salinity2 = data2['salinity'][:,:,312:329,912:937]
    temp2 = data2['temp'][:,:,312:329,912:937]
    u2 = data2['u'][:,:,312:329,912:937]
    v2 = data2['v'][:,:,312:329,912:937]
    print("salinity2.shape:{}".format(salinity2.shape))
    print("mld2.shape:{}".format(mld2.shape))
    print(2)

    data3 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_03_deep30_all_area.npz'.format(cc,cc))
    time3 = data3['time'][:]
    mld3 = data3['mld'][:,312:329,912:937]
    salinity3 = data3['salinity'][:,:,312:329,912:937]
    temp3 = data3['temp'][:,:,312:329,912:937]
    u3 = data3['u'][:,:,312:329,912:937]
    v3 = data3['v'][:,:,312:329,912:937]
    print("salinity3.shape:{}".format(salinity3.shape))
    print("mld3.shape:{}".format(mld3.shape))

    print(3)

    data4 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_04_deep30_all_area.npz'.format(cc,cc))
    time4 = data4['time'][:]
    mld4 = data4['mld'][:,312:329,912:937]
    salinity4 = data4['salinity'][:,:,312:329,912:937]
    temp4 = data4['temp'][:,:,312:329,912:937]
    u4 = data4['u'][:,:,312:329,912:937]
    v4 = data4['v'][:,:,312:329,912:937]
    print("salinity4.shape:{}".format(salinity4.shape))
    print("mld4.shape:{}".format(mld4.shape))
    print(4)

    data5 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_05_deep30_all_area.npz'.format(cc,cc))
    time5 = data5['time'][:]
    mld5 = data5['mld'][:,312:329,912:937]
    salinity5 = data5['salinity'][:,:,312:329,912:937]
    temp5 = data5['temp'][:,:,312:329,912:937]
    u5 = data5['u'][:,:,312:329,912:937]
    v5 = data5['v'][:,:,312:329,912:937]
    print("salinity5.shape:{}".format(salinity5.shape))
    print("mld5.shape:{}".format(mld5.shape))
    print(5)

    data6 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_06_deep30_all_area.npz'.format(cc,cc))
    time6 = data6['time'][:]
    mld6 = data6['mld'][:,312:329,912:937]
    salinity6 = data6['salinity'][:,:,312:329,912:937]
    temp6 = data6['temp'][:,:,312:329,912:937]
    u6 = data6['u'][:,:,312:329,912:937]
    v6 = data6['v'][:,:,312:329,912:937]
    print("salinity6.shape:{}".format(salinity6.shape))
    print("mld6.shape:{}".format(mld6.shape))
    print(6)

    data7 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_07_deep30_all_area.npz'.format(cc,cc))
    time7 = data7['time'][:]
    mld7 = data7['mld'][:,312:329,912:937]
    salinity7 = data7['salinity'][:,:,312:329,912:937]
    temp7 = data7['temp'][:,:,312:329,912:937]
    u7 = data7['u'][:,:,312:329,912:937]
    v7 = data7['v'][:,:,312:329,912:937]
    print("salinity7.shape:{}".format(salinity7.shape))
    print("mld7.shape:{}".format(mld7.shape))
    print(7)

    data8 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_08_deep30_all_area.npz'.format(cc,cc))
    time8 = data8['time'][:]
    mld8 = data8['mld'][:,312:329,912:937]
    salinity8 = data8['salinity'][:,:,312:329,912:937]
    temp8 = data8['temp'][:,:,312:329,912:937]
    u8 = data8['u'][:,:,312:329,912:937]
    v8 = data8['v'][:,:,312:329,912:937]
    print("salinity8.shape:{}".format(salinity8.shape))
    print("mld8.shape:{}".format(mld8.shape))
    print(8)

    data9 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_09_deep30_all_area.npz'.format(cc,cc))
    time9 = data9['time'][:]
    mld9 = data9['mld'][:,312:329,912:937]
    salinity9 = data9['salinity'][:,:,312:329,912:937]
    temp9 = data9['temp'][:,:,312:329,912:937]
    u9 = data9['u'][:,:,312:329,912:937]
    v9 = data9['v'][:,:,312:329,912:937]
    print("salinity9.shape:{}".format(salinity9.shape))
    print("mld9.shape:{}".format(mld9.shape))
    print(9)

    data10 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_10_deep30_all_area.npz'.format(cc,cc))
    time10 = data10['time'][:]
    mld10 = data10['mld'][:,312:329,912:937]
    salinity10 = data10['salinity'][:,:,312:329,912:937]
    temp10 = data10['temp'][:,:,312:329,912:937]
    u10 = data10['u'][:,:,312:329,912:937]
    v10 = data10['v'][:,:,312:329,912:937]
    print("salinity10.shape:{}".format(salinity10.shape))
    print("mld10.shape:{}".format(mld10.shape))
    print(10)

    data11 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_11_deep30_all_area.npz'.format(cc,cc))
    time11 = data11['time'][:]
    mld11 = data11['mld'][:,312:329,912:937]
    salinity11 = data11['salinity'][:,:,312:329,912:937]
    temp11 = data11['temp'][:,:,312:329,912:937]
    u11 = data11['u'][:,:,312:329,912:937]
    v11 = data11['v'][:,:,312:329,912:937]
    print("salinity11.shape:{}".format(salinity11.shape))
    print("mld11.shape:{}".format(mld11.shape))
    print(11)

    data12 = np.load(r'G:\synthesis_data\199{}\reanalysis_9{}_12_deep30_all_area.npz'.format(cc,cc))
    time12 = data12['time'][:]
    mld12 = data12['mld'][:,312:329,912:937]
    salinity12 = data12['salinity'][:,:,312:329,912:937]
    temp12 = data12['temp'][:,:,312:329,912:937]
    u12 = data12['u'][:,:,312:329,912:937]
    v12 = data12['v'][:,:,312:329,912:937]
    ...
    np.savez(r'D:\heat_wave\WEIO\last\analysis_deep\reanalysis_data_1993{}_WEIO_area.npz'.format(cc),time = time, lat = lat1, lon = lon1, mld = mld,
...
for aa in range(1,10):
    ...
    np.savez(r'D:\heat_wave\WEIO\last\analysis_deep\reanalysis_data_200{}_WEIO_area.npz'.format(aa),time = time, lat = lat1, lon = lon1, mld = mld,
                           salinity = salinity, temp = temp, u = u, v = v)
...
for bb in range(10,20):
    ...
    np.savez(r'D:\heat_wave\WEIO\last\analysis_deep\reanalysis_data_20{}_WEIO_area.npz'.format(bb),time = time, lat = lat1, lon = lon1, mld = mld,
                           salinity = salinity, temp = temp, u = u, v = v)

...
path = r'G:\data\SST\SSTA---NOAA\93_19\sst.day.anom.1993.nc'
nc0 = Dataset(path)
print(nc0.variables)
time0 = nc0.variables['time'][:]  # 815232
# print((time0 / 24) - 65377)
time0 = time0.data
time0 = time0  - 66473 - 4018
print(time0)
...
time0 = time0
# # #
todo1 = r'G:\data\SST\SSTA---NOAA\93_19\*.nc'
# # # todo1 = todo1[1:]
...
for i in list_nc0:
    ...
    #     print(time1)
    time1 = time1.data
    time1 = time1  -66473 - 4018
    print(time1)
#
    sst1 = nc1.variables['anom'][:,:,:]
    ...
    np.savez(r'D:\heat_wave\SSTa_93_19_expand_all_area.npz', time=time0, lat=lat, lon=lon, ssta = sst0,
             )

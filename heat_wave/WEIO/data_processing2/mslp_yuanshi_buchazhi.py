...
lat2 = lat1[30:43]  #15 12.5 10 7.5 5 2.5 0 -2.5 -5 -7.5 -10 -12.5 -15

lon2 = lon1[18:31]  # 45  47.5  50  52.5  57.5  60  62.5  67.5  70  72.5  75

mslp2 = mslp1[:,30:43,18:31]  # 单位 pa
...
mslp_detrended = mslp_detrended.reshape(-1,13,13)
...
mslp00 = mslp00.reshape(9855,13,13)
# print(sst00)
...
mslp_detrended00 = mslp_detrended00.reshape(9855,13,13)
#

np.savez(r'D:\heat_wave\WEIO\sea_level_press_WEIO_origin', lat = lat2, lon = lon2,

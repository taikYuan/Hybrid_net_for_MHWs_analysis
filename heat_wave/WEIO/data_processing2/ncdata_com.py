...
path = r'G:\data\wind\shw\wind_12_time\2000_2005\2000010112-IFR-L4-EWSB-BlendedWind-GLO-025-6H-REPv6-20201002T095401-fv1.0.nc'
nc0 = Dataset(path)
...
# lon00 = lon[936:985] #  54.0625  54.3125 ... 65.8125  66.0625
# lat00 = lat[287:353] #  - 8.1875 -7.9375 ... 7.8125  8.0625   # 66
#
# print(lon00)
# # # print(lat00)
# # # lat lon
# eastward_wind0 = nc0.variables['eastward_wind'][:,287:353,936:985]  # lat  lon
# northward_wind0 = nc0.variables['northward_wind'][:,287:353,936:985]  # lat  lon
# wind_vector_divergence0 = nc0.variables['wind_vector_divergence'][:,287:353,936:985]  # lat  lon
# wind_stress0 = nc0.variables['wind_stress'][:,287:353,936:985]  # lat  lon
# surface_downward_eastward_stress0 = nc0.variables['surface_downward_eastward_stress'][:,287:353,936:985]  # lat  lon
# surface_downward_northward_stress0 = nc0.variables['surface_downward_northward_stress'][:,287:353,936:985]  # lat  lon
# wind_stress_curl0 = nc0.variables['wind_stress_curl'][:,287:353,936:985]  # lat  lon
# wind_stress_divergence0 = nc0.variables['wind_stress_divergence'][:,287:353,936:985]  # lat  lon
# wind_speed_rms0 = nc0.variables['wind_speed_rms'][:,287:353,936:985]  # lat  lon
# eastward_wind_rms0 = nc0.variables['eastward_wind_rms'][:,287:353,936:985]  # lat  lon
# northward_wind_rms0 = nc0.variables['northward_wind_rms'][:,287:353,936:985]  # lat  lon
# sampling_length0 = nc0.variables['sampling_length'][:,287:353,936:985]  # lat  lon
# surface_type0 = nc0.variables['surface_type'][:,287:353,936:985]  # lat  lon
...
# time0 = time0
# # # #
# todo1 = r'G:\data\wind\shw\wind_12_time\2000_2005\*.nc'
# # # # todo1 = todo1[1:]
...
#     # print(time1)
# #
#     eastward_wind1 = nc1.variables['eastward_wind'][:, 287:353, 936:985]  # lat  lon
#     northward_wind1 = nc1.variables['northward_wind'][:, 287:353, 936:985]  # lat  lon
#     wind_vector_divergence1 = nc1.variables['wind_vector_divergence'][:, 287:353, 936:985]  # lat  lon
#     wind_stress1 = nc1.variables['wind_stress'][:, 287:353, 936:985]  # lat  lon
#     surface_downward_eastward_stress1 = nc1.variables['surface_downward_eastward_stress'][:, 287:353, 936:985]  # lat  lon
#     surface_downward_northward_stress1 = nc1.variables['surface_downward_northward_stress'][:, 287:353,936:985]  # lat  lon
#     wind_stress_curl1 = nc1.variables['wind_stress_curl'][:, 287:353, 936:985]  # lat  lon
#     wind_stress_divergence1 = nc1.variables['wind_stress_divergence'][:, 287:353, 936:985]  # lat  lon
#     wind_speed_rms1 = nc1.variables['wind_speed_rms'][:, 287:353, 936:985]  # lat  lon
#     eastward_wind_rms1 = nc1.variables['eastward_wind_rms'][:, 287:353, 936:985]  # lat  lon
#     northward_wind_rms1 = nc1.variables['northward_wind_rms'][:, 287:353, 936:985]  # lat  lon
#     sampling_length1 = nc1.variables['sampling_length'][:, 287:353, 936:985]  # lat  lon
#     surface_type1 = nc1.variables['surface_type'][:, 287:353, 936:985]  # lat  lon
#
...
#             break
# # #
#     np.savez(r'D:\heat_wave\WEIO\expand_WEIO\other_variables\wind_00_05_pacific_warm_pool_area.npz', time=time0, lat=lat00, lon=lon00,

...
lon00 = lon[216:265] #  54.125 54.25 ... 66.125
lat00 = lat[327:393] #  - 8.1875 -7.9375 ... 7.8125  8.0625   # 66

# print(lat00)

# # # print(lat00)
# # # lat lon
# sea_surface_height_above_geoid0 = nc0.variables['adt'][:,327:392,216:265]  # lat  lon   # Absolute dynamic topography
...
#
# surface_geostrophic_eastward_sea_water_velocity0 = nc0.variables['ugos'][:,327:392,216:265]  # Absolute geostrophic velocity: zonal component
# surface_geostrophic_northward_sea_water_velocity0 = nc0.variables['vgos'][:,327:392,216:265]  # Absolute geostrophic velocity: meridian component
# sea_surface_height_above_sea_level0 = nc0.variables['sla'][:,327:392,216:265]  # Sea level anomaly
...
# surface_geostrophic_eastward_sea_water_velocity_assuming_sea_level_for_geoid0 = nc0.variables['ugosa'][:,327:392,216:265]  # Geostrophic velocity anomalies: zonal component
# surface_geostrophic_northward_sea_water_velocity_assuming_sea_level_for_geoid0 = nc0.variables['vgosa'][:,327:392,216:265]  # Geostrophic velocity anomalies: meridian component
#
#
# # # # # # # #
...
#     time1 = time1 - 15705
#     # print(time1)
#     sea_surface_height_above_geoid1 = nc1.variables['adt'][:, 327:392,216:265]  # lat  lon   # Absolute dynamic topography
#     # The absolute dynamic topography is the sea surface height above geoid; the adt is obtained as follows: adt=sla+mdt where mdt
#     # is the mean dynamic topography; see the product user manual for details
#
#     surface_geostrophic_eastward_sea_water_velocity1 = nc1.variables['ugos'][:, 327:392,216:265]  # Absolute geostrophic velocity: zonal component
#     surface_geostrophic_northward_sea_water_velocity1 = nc1.variables['vgos'][:, 327:392,216:265]  # Absolute geostrophic velocity: meridian component
#     sea_surface_height_above_sea_level1 = nc1.variables['sla'][:, 327:392, 216:265]  # Sea level anomaly
#     # The sea level anomaly is the sea surface height above mean sea surface; it is referenced to the [1993, 2012] period; see the product user manual for details
#     surface_geostrophic_eastward_sea_water_velocity_assuming_sea_level_for_geoid1 = nc1.variables['ugosa'][:, 327:392,216:265]  # Geostrophic velocity anomalies: zonal component
#     surface_geostrophic_northward_sea_water_velocity_assuming_sea_level_for_geoid1 = nc1.variables['vgosa'][:, 327:392,216:265]  # Geostrophic velocity anomalies: meridian component
#
#
...
#             break
# # # #
#     np.savez(r'D:\heat_wave\WEIO\expand_WEIO\other_variables\ssh_19_expand_WEIO_area.npz', time=time0, lat=lat00, lon=lon00,

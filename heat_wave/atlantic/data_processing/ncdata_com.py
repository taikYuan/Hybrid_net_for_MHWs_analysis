...
# print(lat00)
# lat lon
sst0 = nc0.variables['sst'][:,239:321,1319:1401]  # lat  lon
...
for i in list_nc0:
    ...
    # print(time1)
#
    sst1 = nc1.variables['sst'][:,239:321,1319:1401]
    sst1 = sst1.data
    print(np.mean(sst1))
...
#
    ...
    for i in range(len(time) - 1):
        if time[i + 1] - time[i] != 1:
            ...
            break
#
    np.savez(r'D:\heat_wave\atlantic\SST_93_19_expand_atlantic_area.npz', time=time0, lat=lat00, lon=lon00, sst = sst0,
             )
#

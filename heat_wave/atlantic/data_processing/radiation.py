...
path = r'H:\radiction_0.25\WEIO\expand_WEIO\surface_sensible_heat_flux.nc'
nc0 = Dataset(path)
print(nc0.variables)
...
np.savez(r'D:\heat_wave\atlantic\rediation_data\EC_sshf_93_19_atlantic_expand_ocean_area.npz', time=time0,lat=lat0, lon=lon0, sshf = sshf0)

...
for cc in range(0,1):
    ...
    mld1 = data['mld'][:,200:281,600:681]
    print(mld1.shape) #(31, 41, 201)

    salinity1 = data['salinity'][:]
    print('salinity1.shape:{}'.format(salinity1.shape)) #(31, 30, 681, 1440) #30是深度

    salinity1 = salinity1[:,:,200:281,600:681]
    print(salinity1.shape) #(31, 30, 41, 201) #30是深度

    temp1 = data['temp'][:,:,200:281,600:681]
    print(temp1.shape)
    print(np.mean(temp1))
    u1 = data['u'][:,:,200:281,600:681]
    #
    v1 = data['v'][:,:,200:281,600:681]
    #
    #
    data2 = np.load(r'G:\synthesis_data\200{}\reanalysis_0{}_02_deep30_all_area.npz'.format(cc,cc))
    time2 = data2['time'][:]
    mld2 = data2['mld'][:,200:281,600:681]
    salinity2 = data2['salinity'][:,:,200:281,600:681]
    temp2 = data2['temp'][:,:,200:281,600:681]
    u2 = data2['u'][:,:,200:281,600:681]
    v2 = data2['v'][:,:,200:281,600:681]
    ...
    time3 = data3['time'][:]
    mld3 = data3['mld'][:, 200:281, 600:681]
    salinity3 = data3['salinity'][:, :, 200:281, 600:681]
    temp3 = data3['temp'][:, :, 200:281, 600:681]
    u3 = data3['u'][:, :, 200:281, 600:681]
    v3 = data3['v'][:, :, 200:281, 600:681]
    ...
    time4 = data4['time'][:]
    mld4 = data4['mld'][:, 200:281, 600:681]
    salinity4 = data4['salinity'][:, :, 200:281, 600:681]
    temp4 = data4['temp'][:, :, 200:281, 600:681]
    u4 = data4['u'][:, :, 200:281, 600:681]
    v4 = data4['v'][:, :, 200:281, 600:681]
    ...
    time5 = data5['time'][:]
    mld5 = data5['mld'][:, 200:281, 600:681]
    salinity5 = data5['salinity'][:, :, 200:281, 600:681]
    temp5 = data5['temp'][:, :, 200:281, 600:681]
    u5 = data5['u'][:, :, 200:281, 600:681]
    v5 = data5['v'][:, :, 200:281, 600:681]
    ...
    time6 = data6['time'][:]
    mld6 = data6['mld'][:, 200:281, 600:681]
    salinity6 = data6['salinity'][:, :, 200:281, 600:681]
    temp6 = data6['temp'][:, :, 200:281, 600:681]
    u6 = data6['u'][:, :, 200:281, 600:681]
    v6 = data6['v'][:, :, 200:281, 600:681]
    ...
    time7 = data7['time'][:]
    mld7 = data7['mld'][:, 200:281, 600:681]
    salinity7 = data7['salinity'][:, :, 200:281, 600:681]
    temp7 = data7['temp'][:, :, 200:281, 600:681]
    u7 = data7['u'][:, :, 200:281, 600:681]
    v7 = data7['v'][:, :, 200:281, 600:681]
    ...
    time8 = data8['time'][:]
    mld8 = data8['mld'][:, 200:281, 600:681]
    salinity8 = data8['salinity'][:, :, 200:281, 600:681]
    temp8 = data8['temp'][:, :, 200:281, 600:681]
    u8 = data8['u'][:, :, 200:281, 600:681]
    v8 = data8['v'][:, :, 200:281, 600:681]
    ...
    time9 = data9['time'][:]
    mld9 = data9['mld'][:, 200:281, 600:681]
    salinity9 = data9['salinity'][:, :, 200:281, 600:681]
    temp9 = data9['temp'][:, :, 200:281, 600:681]
    u9 = data9['u'][:, :, 200:281, 600:681]
    v9 = data9['v'][:, :, 200:281, 600:681]
    ...
    time10 = data10['time'][:]
    mld10 = data10['mld'][:, 200:281, 600:681]
    salinity10 = data10['salinity'][:, :, 200:281, 600:681]
    temp10 = data10['temp'][:, :, 200:281, 600:681]
    u10 = data10['u'][:, :, 200:281, 600:681]
    v10 = data10['v'][:, :, 200:281, 600:681]
    ...
    time11 = data11['time'][:]
    mld11 = data11['mld'][:, 200:281, 600:681]
    salinity11 = data11['salinity'][:, :, 200:281, 600:681]
    temp11 = data11['temp'][:, :, 200:281, 600:681]
    u11 = data11['u'][:, :, 200:281, 600:681]
    v11 = data11['v'][:, :, 200:281, 600:681]
    ...
    time12 = data12['time'][:]
    mld12 = data12['mld'][:, 200:281, 600:681]
    salinity12 = data12['salinity'][:, :, 200:281, 600:681]
    temp12 = data12['temp'][:, :, 200:281, 600:681]
    u12 = data12['u'][:, :, 200:281, 600:681]
    v12 = data12['v'][:, :, 200:281, 600:681]
    ...
    np.savez(r'D:\heat_wave\atlantic\expand_atlantic_reanalysis\reanalysis_data_200{}_expand_atlantic_area.npz'.format(cc),time = time, lat = lat1, lon = lon1, mld = mld,
...
#     print("v.shape:{}".format(v.shape))
#
#     np.savez(r'D:\heat_wave\atlantic\expand_atlantic_reanalysis\reanalysis_data_200{}_expand_atlantic_area.npz'.format(aa),time = time, lat = lat1, lon = lon1, mld = mld,
#                            salinity = salinity, temp = temp, u = u, v = v)
#
#
...
#     print("v.shape:{}".format(v.shape))
#
#     np.savez(r'D:\heat_wave\atlantic\expand_atlantic_reanalysis\reanalysis_data_20{}_expand_atlantic_area.npz'.format(bb),time = time, lat = lat1, lon = lon1, mld = mld,
#                            salinity = salinity, temp = temp, u = u, v = v)

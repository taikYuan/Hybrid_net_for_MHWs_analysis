...
#
# print(dT_dt_test.shape) #torch.Size([1988, 1, 80, 80])
...
for seed in range(1,6):
    for epoches in range(200,201,100):
        ...
        setup_seed(seed)
#
        model_weights1 = './cnn_optimized_formula_f(2)_epo{}_lay3_lr1e-3_e{}_1day_model_weights.pth'.format(epoches,seed)
        ...
        for epoch in range(epochs):
            ...
            for i, data in tqdm(enumerate(trainloader)):
                ...
                label = label.cuda()
                optimizer.zero_grad()
                # train_data = torch.cat((sst_obser_train, Q_net_train, mld_train, u_train, v_train, T_d_train, v_d_train, dT_dt_train, dT_dx_train, dT_dy_train), dim=1)
                ...
                T_1 = T_m.reshape(-1,1,80,80)  #hycom  假设为当前时刻的观测
...
#
            ...
            if valid_loss < best_score1:  # 求s的最小值  ---》最大值反过来  inf符号也要反过来
                ...
                torch.save(model.state_dict(),
                           './cnn_optimize_formula_lr1e-3_f(2)_model_{}_layer3_1day_e{}.pt'.format(epoches, seed))

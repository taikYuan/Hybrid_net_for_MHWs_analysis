...
lon00 = lon[1319:1401] # 329.875 330.125 ... 349.875 350.125
lon11 = lon[1301:1381] # 325.375 325.625 ... 344.875 345.125  # 80
print(lon11)
# print(lat00)
# lat lon
sst0 = nc0.variables['sst'][:,319:401,1301:1381]  # lat  lon
...
#     # print(time1)
# #
#     sst1 = nc1.variables['sst'][:,319:401,1301:1381]
#     sst1 = sst1.data
#     print(np.mean(sst1))
...
#             break
# #
#     np.savez(r'D:\heat_wave\atlantic\expand_area1\SST_82_21_expand_atlantic_1_area.npz', time=time0, lat=lat00, lon=lon00, sst = sst0,
#              )
#

...
for cc in range(0,1):
    ...
    lon1 = lon[581:661]
    print(lon1) # 34.75w - 15.125w  # 80
    print(lon1.shape)

    mld1 = data['mld'][:,280:361,581:661]
    print(mld1.shape) #(31, 41, 201)

    salinity1 = data['salinity'][:]
    print('salinity1.shape:{}'.format(salinity1.shape)) #(31, 30, 681, 1440) #30是深度

    salinity1 = salinity1[:,:,280:361,581:661]
    print(salinity1.shape) #(31, 30, 41, 201) #30是深度

    temp1 = data['temp'][:,:,280:361,581:661]
    print(temp1.shape)
    print(np.mean(temp1))

    u1 = data['u'][:,:,280:361,581:661]
    #
    v1 = data['v'][:,:,280:361,581:661]
    #
    #
    data2 = np.load(r'G:\synthesis_data\200{}\reanalysis_0{}_02_deep30_all_area.npz'.format(cc,cc))
    time2 = data2['time'][:]
    mld2 = data2['mld'][:,280:361,581:661]
    salinity2 = data2['salinity'][:,:,280:361,581:661]
    temp2 = data2['temp'][:,:,280:361,581:661]
    u2 = data2['u'][:,:,280:361,581:661]
    v2 = data2['v'][:,:,280:361,581:661]
    ...
    time3 = data3['time'][:]
    mld3 = data3['mld'][:,280:361,581:661]
    salinity3 = data3['salinity'][:,:,280:361,581:661]
    temp3 = data3['temp'][:,:,280:361,581:661]
    u3 = data3['u'][:,:,280:361,581:661]
    v3 = data3['v'][:,:,280:361,581:661]
    ...
    time4 = data4['time'][:]
    mld4 = data4['mld'][:,280:361,581:661]
    salinity4 = data4['salinity'][:,:,280:361,581:661]
    temp4 = data4['temp'][:,:,280:361,581:661]
    u4 = data4['u'][:,:,280:361,581:661]
    v4 = data4['v'][:,:,280:361,581:661]
    ...
    time5 = data5['time'][:]
    mld5 = data5['mld'][:,280:361,581:661]
    salinity5 = data5['salinity'][:,:,280:361,581:661]
    temp5 = data5['temp'][:,:,280:361,581:661]
    u5 = data5['u'][:,:,280:361,581:661]
    v5 = data5['v'][:,:,280:361,581:661]
    ...
    time6 = data6['time'][:]
    mld6 = data6['mld'][:,280:361,581:661]
    salinity6 = data6['salinity'][:,:,280:361,581:661]
    temp6 = data6['temp'][:,:,280:361,581:661]
    u6 = data6['u'][:,:,280:361,581:661]
    v6 = data6['v'][:,:,280:361,581:661]
    ...
    time7 = data7['time'][:]
    mld7 = data7['mld'][:,280:361,581:661]
    salinity7 = data7['salinity'][:,:,280:361,581:661]
    temp7 = data7['temp'][:,:,280:361,581:661]
    u7 = data7['u'][:,:,280:361,581:661]
    v7 = data7['v'][:,:,280:361,581:661]
    ...
    time8 = data8['time'][:]
    mld8 = data8['mld'][:,280:361,581:661]
    salinity8 = data8['salinity'][:,:,280:361,581:661]
    temp8 = data8['temp'][:,:,280:361,581:661]
    u8 = data8['u'][:,:,280:361,581:661]
    v8 = data8['v'][:,:,280:361,581:661]
    ...
    time9 = data9['time'][:]
    mld9 = data9['mld'][:,280:361,581:661]
    salinity9 = data9['salinity'][:,:,280:361,581:661]
    temp9 = data9['temp'][:,:,280:361,581:661]
    u9 = data9['u'][:,:,280:361,581:661]
    v9 = data9['v'][:,:,280:361,581:661]
    ...
    time10 = data10['time'][:]
    mld10 = data10['mld'][:,280:361,581:661]
    salinity10 = data10['salinity'][:,:,280:361,581:661]
    temp10 = data10['temp'][:,:,280:361,581:661]
    u10 = data10['u'][:,:,280:361,581:661]
    v10 = data10['v'][:,:,280:361,581:661]
    ...
    time11 = data11['time'][:]
    mld11 = data11['mld'][:,280:361,581:661]
    salinity11 = data11['salinity'][:,:,280:361,581:661]
    temp11 = data11['temp'][:,:,280:361,581:661]
    u11 = data11['u'][:,:,280:361,581:661]
    v11 = data11['v'][:,:,280:361,581:661]
    ...
    time12 = data12['time'][:]
    mld12 = data12['mld'][:,280:361,581:661]
    salinity12 = data12['salinity'][:,:,280:361,581:661]
    temp12 = data12['temp'][:,:,280:361,581:661]
    u12 = data12['u'][:,:,280:361,581:661]
    v12 = data12['v'][:,:,280:361,581:661]
    ...
    np.savez(r'D:\heat_wave\atlantic\expand_area1\reanalysis\reanalysis_data_200{}_expand_atlantic1_area.npz'.format(cc),time = time, lat = lat1, lon = lon1, mld = mld,
...
# #     print("v.shape:{}".format(v.shape))
# #
# #     np.savez(r'D:\heat_wave\atlantic\expand_area1\reanalysis\reanalysis_data_200{}_expand_atlantic1_area.npz'.format(aa),time = time, lat = lat1, lon = lon1, mld = mld,
# #                            salinity = salinity, temp = temp, u = u, v = v)
# #
# #
# for bb in range(14,20):
#
#
...
#     print("v.shape:{}".format(v.shape))
#
#     np.savez(r'D:\heat_wave\atlantic\expand_area1\reanalysis\reanalysis_data_20{}_expand_atlantic1_area.npz'.format(bb),time = time, lat = lat1, lon = lon1, mld = mld,
#                            salinity = salinity, temp = temp, u = u, v = v)

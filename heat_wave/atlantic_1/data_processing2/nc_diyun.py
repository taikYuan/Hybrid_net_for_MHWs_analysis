...
path =r'D:\heat_wave\atlantic\expand_area1\low_cloud\low_cloud_cover.nc'
nc0 = Dataset(path)
...
low_cloud_cover00 = low_cloud_cover00.reshape(9861,81,81)
# print(sst00)
...
np.savez(r'D:\heat_wave\atlantic\expand_area1\low_cloud\low_cloud_cover_pacific_chazhi', lat = lat, lon = lon,

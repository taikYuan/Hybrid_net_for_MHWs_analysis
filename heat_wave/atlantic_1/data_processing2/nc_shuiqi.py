...
path =r'D:\heat_wave\atlantic\expand_area1\low_cloud\potential_evaporation.nc'
nc0 = Dataset(path)
...
potential_evaporation00 = potential_evaporation00.reshape(9861,81,81)
# print(sst00)
...
np.savez(r'D:\heat_wave\atlantic\expand_area1\low_cloud\potential_evaporation_pacific_chazhi', lat = lat, lon = lon,

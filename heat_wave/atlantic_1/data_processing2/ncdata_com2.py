...
lon00 = lon[580:661] #  -35 -34.75 ... -15.25 -15
lat00 = lat[280:361] #  -10 -9.75 ... 9.75  10  # 66

print(lon00)
# # print(lat00)
# # lat lon
eastward_wind0 = nc0.variables['eastward_wind'][:,280:361,580:661]  # lat  lon
northward_wind0 = nc0.variables['northward_wind'][:,280:361,580:661]   # lat  lon
wind_vector_divergence0 = nc0.variables['wind_vector_divergence'][:,280:361,580:661]   # lat  lon
wind_stress0 = nc0.variables['wind_stress'][:,280:361,580:661] # lat  lon
surface_downward_eastward_stress0 = nc0.variables['surface_downward_eastward_stress'][:,280:361,580:661]   # lat  lon
surface_downward_northward_stress0 = nc0.variables['surface_downward_northward_stress'][:,280:361,580:661]  # lat  lon
wind_stress_curl0 = nc0.variables['wind_stress_curl'][:,280:361,580:661]   # lat  lon
wind_stress_divergence0 = nc0.variables['wind_stress_divergence'][:,280:361,580:661]  # lat  lon
wind_speed_rms0 = nc0.variables['wind_speed_rms'][:,280:361,580:661]   # lat  lon
eastward_wind_rms0 = nc0.variables['eastward_wind_rms'][:,280:361,580:661]   # lat  lon
northward_wind_rms0 = nc0.variables['northward_wind_rms'][:,280:361,580:661]  # lat  lon
sampling_length0 = nc0.variables['sampling_length'][:,280:361,580:661]  # lat  lon
surface_type0 = nc0.variables['surface_type'][:,280:361,580:661]   # lat  lon
...
for i in list_nc0:
    ...
    # print(time1)
#
    eastward_wind1 = nc1.variables['eastward_wind'][:,280:361,580:661]   # lat  lon
    northward_wind1 = nc1.variables['northward_wind'][:,280:361,580:661]   # lat  lon
    wind_vector_divergence1 = nc1.variables['wind_vector_divergence'][:,280:361,580:661]   # lat  lon
    wind_stress1 = nc1.variables['wind_stress'][:,280:361,580:661]   # lat  lon
    surface_downward_eastward_stress1 = nc1.variables['surface_downward_eastward_stress'][:,280:361,580:661]  # lat  lon
    surface_downward_northward_stress1 = nc1.variables['surface_downward_northward_stress'][:,280:361,580:661]  # lat  lon
    wind_stress_curl1 = nc1.variables['wind_stress_curl'][:,280:361,580:661]   # lat  lon
    wind_stress_divergence1 = nc1.variables['wind_stress_divergence'][:,280:361,580:661]  # lat  lon
    wind_speed_rms1 = nc1.variables['wind_speed_rms'][:,280:361,580:661] # lat  lon
    eastward_wind_rms1 = nc1.variables['eastward_wind_rms'][:,280:361,580:661]  # lat  lon
    northward_wind_rms1 = nc1.variables['northward_wind_rms'][:,280:361,580:661]  # lat  lon
    sampling_length1 = nc1.variables['sampling_length'][:,280:361,580:661]  # lat  lon
    surface_type1 = nc1.variables['surface_type'][:,280:361,580:661]   # lat  lon
    ...
    for i in range(len(time) - 1):
        if time[i + 1] - time[i] != 1:
            ...
            break
# #
    np.savez(r'D:\heat_wave\atlantic\aonther_variables\wind_19_atlantic_area.npz', time=time0, lat=lat00, lon=lon00,

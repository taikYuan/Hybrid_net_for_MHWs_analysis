...
lat00 = lat[319:401] # -10.125 -9.875 ... 9.875 10.125  # 66
...
for i in list_nc0:
    ...
    for i in range(len(time) - 1):
        if time[i + 1] - time[i] != 1:
            ...
            break
# # #
    np.savez(r'D:\heat_wave\atlantic\expand_area1\ssh\ssh_93_19_atlantic_area.npz', time=time0, lat=lat00, lon=lon00,

...
for seed in range(1,6):
    for epoches in range(100,102,100):
        ...
        checkpoint = torch.load(
            r'C:\Users\mymylove\Desktop\zege\heat_wave\atlantic_1\正式训练\f(1_2_3_4)\cnn_optimized_formula_f(1_2_3_4)_epo{}_lay3_lr1e-3_e{}_1day_model_weights.pth'.format(epoches,seed))
        ...
        model = ConvNet(input_dim=1, input_dim1=7, hidden_dim=1, kernel_size1=(1, 3), padding1=(0, 1),
                        kernel_size2=(1, 3), padding2=(0, 1), kernel_size3=(1, 3), padding3=(
            0, 1))  # padding2=(0, 1, 1), kernel_size3=(1, 3, 3), padding3=(0, 1, 1)).cuda()
        ...
        for i, data in tqdm(enumerate(testloader)):
            ...
            data1 =  w_e * ((T_m - T_d) / h_m) +  v* (dT_dy) +  u* (dT_dx)  + Q / (1025 * 4000 * h_m)  #(1)  data1.shape:torch.Size([32, 1, 40, 80])

            data1 = data1.reshape(-1,1,80,79)

            out = model(data1)  # ---> f(1)  ([32, 1, 40, 80])

            dT_dt1 =  out      #torch.Size([32, 1, 40, 80])

...
for seed in range(1,6):
    for epoches in range(100,101,100):
        ...
        setup_seed(seed)
#
        model_weights1 = './cnn_optimized_formula_f(1_2_3_4)_epo{}_lay3_lr1e-3_e{}_1day_model_weights.pth'.format(epoches,seed)
        ...
        for epoch in range(epochs):
            ...
            for i, data in tqdm(enumerate(trainloader)):
                ...
                # ...
                data1 = Q / (1025 * 4000 * h_m) +  w_e * ((T_m - T_d) / h_m) + v * (dT_dy)  +  u* (dT_dx)  #(1)  data1.shape:torch.Size([32, 1, 40, 80])
...
#
            ...
            if valid_loss < best_score1:  # 求s的最小值  ---》最大值反过来  inf符号也要反过来
                ...
                torch.save(model.state_dict(),
                           './cnn_optimize_formula_lr1e-3_f(1_2_3_4)_model_{}_layer3_1day_e{}.pt'.format(epoches, seed))

...
lat00 = lat[339:381] # -5.125 -4.875 ... 4.875 5.125
lon00 = lon[759:961] # 189.875 190.125 ... 239.875 240.125
print(lon00)
# print(lat00)
# lat lon
sst0 = nc0.variables['sst'][:,339:381,759:961]  # lat  lon
...
for i in list_nc0:
    ...
    # print(time1)
#
    sst1 = nc1.variables['sst'][:,339:381,759:961]
    print(np.mean(sst1))
...
# #
    ...
    for i in range(len(time) - 1):
        if time[i + 1] - time[i] != 1:
            ...
            break
#
    np.savez(r'D:\heat_wave\pacific\SST_82_21_expand_pacific_area.npz', time=time0, lat=lat00, lon=lon00, sst = sst0,
             )
#

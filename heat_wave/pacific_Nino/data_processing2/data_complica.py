...
data1 = np.load(r'D:\heat_wave\pacific\last\wind_93_99_pacific_area.npz')
...
data2 = np.load(r'D:\heat_wave\pacific\last\wind_00_05_pacific_area.npz')
...
data3 = np.load(r'D:\heat_wave\pacific\last\wind_06_10_pacific_area.npz')
...
data4 = np.load(r'D:\heat_wave\pacific\last\wind_11_15_pacific_area.npz')
...
data5 = np.load(r'D:\heat_wave\pacific\last\wind_16_17_pacific_area.npz')
...
data6 = np.load(r'D:\heat_wave\pacific\last\wind_18_pacific_area.npz')
...
data7 = np.load(r'D:\heat_wave\pacific\last\wind_19_pacific_area.npz')
...
np.savez(r'D:\heat_wave\pacific\last\wind_93_19_pacific_area.npz', time = time, lat = lat1, lon = lon1, eastward_wind = eastward_wind, northward_wind = northward_wind,

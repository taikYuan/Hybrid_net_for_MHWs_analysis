...
lat2 = lat1[34:39]  # 5 2.5 0 -2.5 -5

lon2 = lon1[76:97]  #190 192.5 ... 237.5 240

mslp2 = mslp1[:,34:39,76:97]  # 单位 pa
...
mslp_detrended = mslp_detrended.reshape(-1,5,21)
...
# y = np.arange(189.875, 240, 0.25) #(201,)
# x = np.arange(-4.875, 5.2, 0.25)   #(41,)
...
mslp00 = mslp00.reshape(9855,5,21)
# print(sst00)
...
mslp_detrended00 = mslp_detrended00.reshape(9855,5,21)
...
y_new = np.arange(190, 240.2, 0.25) #(201   ,)
x_new = np.arange(-5, 5.2, 0.25)  #(41,)
print(x_new.shape)
print(y_new.shape)
# # # #
...
print(mslp00.shape) #(2410650, 1)
sst00 = mslp00.reshape(9855, 41,201)
print(mslp00.shape)
print(np.mean(mslp00))
print(np.max(mslp00))
print(np.min(mslp00))
...
print(mslp_detrended00.shape) #(2410650, 1)
mslp_detrended00 = mslp_detrended00.reshape(9855, 41,201)
...
#
# # #
np.savez(r'D:\heat_wave\pacific\sea_level_press_chazhi', lat = x_new, lon = y_new,

...
lon00 = lon[760:961] #  190.125  190.375 ... 239.875 240.125
lat00 = lat[339:381] # -5.125 -4.875 ...  4.875 5.125  # 66

print(lon00)

# # print(lat00)
# # lat lon
sea_surface_height_above_geoid0 = nc0.variables['adt'][:,339:381,760:961]  # lat  lon   # Absolute dynamic topography
...
surface_geostrophic_eastward_sea_water_velocity0 = nc0.variables['ugos'][:,339:381,760:961]  # Absolute geostrophic velocity: zonal component
surface_geostrophic_northward_sea_water_velocity0 = nc0.variables['vgos'][:,339:381,760:961]   # Absolute geostrophic velocity: meridian component
sea_surface_height_above_sea_level0 = nc0.variables['sla'][:,339:381,760:961]   # Sea level anomaly
...
surface_geostrophic_eastward_sea_water_velocity_assuming_sea_level_for_geoid0 = nc0.variables['ugosa'][:,339:381,760:961]  # Geostrophic velocity anomalies: zonal component
surface_geostrophic_northward_sea_water_velocity_assuming_sea_level_for_geoid0 = nc0.variables['vgosa'][:,339:381,760:961]   # Geostrophic velocity anomalies: meridian component
...
for i in list_nc0:
    ...
    time1 = time1 - 15705
    # print(time1)
    sea_surface_height_above_geoid1 = nc1.variables['adt'][:,339:381,760:961]   # lat  lon   # Absolute dynamic topography
    # The absolute dynamic topography is the sea surface height above geoid; the adt is obtained as follows: adt=sla+mdt where mdt
    # is the mean dynamic topography; see the product user manual for details

    surface_geostrophic_eastward_sea_water_velocity1 = nc1.variables['ugos'][:,339:381,760:961]   # Absolute geostrophic velocity: zonal component
    surface_geostrophic_northward_sea_water_velocity1 = nc1.variables['vgos'][:,339:381,760:961]   # Absolute geostrophic velocity: meridian component
    sea_surface_height_above_sea_level1 = nc1.variables['sla'][:,339:381,760:961]   # Sea level anomaly
    # The sea level anomaly is the sea surface height above mean sea surface; it is referenced to the [1993, 2012] period; see the product user manual for details
    surface_geostrophic_eastward_sea_water_velocity_assuming_sea_level_for_geoid1 = nc1.variables['ugosa'][:,339:381,760:961]   # Geostrophic velocity anomalies: zonal component
    surface_geostrophic_northward_sea_water_velocity_assuming_sea_level_for_geoid1 = nc1.variables['vgosa'][:,339:381,760:961]   # Geostrophic velocity anomalies: meridian component
    ...
    for i in range(len(time) - 1):
        if time[i + 1] - time[i] != 1:
            ...
            break
# # #
    np.savez(r'D:\heat_wave\pacific\last\ssh\ssh_93_19_expand_pacific_area.npz', time=time0, lat=lat00, lon=lon00,
